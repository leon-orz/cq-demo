...
> **阶段修订（2026-05-09）**：当前技术骨架、核心循环、离线收益和本地存档已经落地。后续开发优先服务“构筑选择 -> 推层目标 -> 掉落反馈”，暂不横向铺开强化、套装、转生、多职业和排行榜等长期系统。连续开发路线以 `docs/plans/continuous-development-roadmap-2026-05-09.md` 为准。
